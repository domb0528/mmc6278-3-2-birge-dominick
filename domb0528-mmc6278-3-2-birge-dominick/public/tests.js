          ...
          "city:item": {
            "_embedded": {
              "city:urban_area": {
                ...
                "_links": {
                  ...
                  "ua:cities": {
                    "href": "https://api.teleport.org/api/urban_areas/slug:orlando/cities/"
                  },
                  "ua:continent": {
                  ...
                  "ua:details": {
                    "href": "https://api.teleport.org/api/urban_areas/slug:orlando/details/"
                  },
                  "ua:identifying-city": {
                  ...
                  "ua:images": {
                    "href": "https://api.teleport.org/api/urban_areas/slug:orlando/images/"
                  },
                  "ua:primary-cities": [
                    {
                      "href": "https://api.teleport.org/api/cities/geonameid:4167147/",
                  ...
                  "ua:salaries": {
                    "href": "https://api.teleport.org/api/urban_areas/slug:orlando/salaries/"
                  },
                  "ua:scores": {
                    "href": "https://api.teleport.org/api/urban_areas/slug:orlando/scores/"
                  }
            ...
            "_links": {
              ...
              "city:alternate-names": {
                "href": "https://api.teleport.org/api/cities/geonameid:4167147/alternate_names/"
              },
              "city:country": {
                "href": "https://api.teleport.org/api/countries/iso_alpha2:US/",
                "name": "United States"
        ...
        "_embedded": {
          "city:item": {
            "_links": {
              ...
              "city:alternate-names": {
                "href": "https://api.teleport.org/api/cities/geonameid:4166673/alternate_names/"
              },
              "city:country": {
                "href": "https://api.teleport.org/api/countries/iso_alpha2:US/",
                "name": "United States"
  ...
  "results": [
    {
      ...
      "remote": true,
      "logo": null,
      "url": "https://findwork.dev/113485/multiple-engineering-roles-at-defy-trends",
      "text": "Defy Trends is an AI and data-driven crypto intelligence for investors, traders, researchers, crypto newbies and crypto vets to obtain quality information and actionable insights to make confident crypto investment decisions.<br>We are looking for talented people throughout the entire stack: JavaScript, React, Node, Python, Go, Elixir, Solar, Flink, k8s, and much more. Our hiring efforts focus on Europe and Eastern US.<br>- Senior DevOps&#x2F;Platform Engineer<br>- Senior Data Engineer<br>- Senior Distributed System Engineer<br>- Senior Software Engineer (Python, Go, Elixir)<br>- Senior FullStack Engineer (Python, Django)<br>- Senior FrontEnd Engineer (React)<br>- Blockchain Developer<br>- Data Scientist &#x2F; Blockchain Analyst<br>Feel free to drop me a mail: sebastian at defytrends.tech",
...
describe('Job Location API', () => {
  describe('Statically serves front-end files', () => {
    ...
    it('should serve index.js on "/index.js"', async () => {
    ...
    it('should serve style.css on "/style.css"', async () => {
  ...
  describe('Jobs and City found', () => {
    ...
    it('should return "jobs" and "cityInfo" properties in json response', async () => {
      const response = await request(app)
  ...
  describe('Jobs found but no city info found', () => {
    ...
    it('should return false for "cityInfo"', async () => {
      const response = await request(app)
        .get('/api/city/anycity')
        .expect(200)
        .expect('Content-Type', /json/)
  ...
  describe('City info found but no jobs found', () => {
    ...
    it('should return false for "jobs"', async () => {
      const response = await request(app)
        .get('/api/city/anycity')
        .expect(200)
        .expect('Content-Type', /json/)
  ...
  describe('External API non-200 responses', () => {
    for (const code of [401, 403, 404, 500]) {
      it(`should return a 404 status and error message if both APIs return ${code}`, async () => {
        nock('https://api.teleport.org')
          .get('/api/cities/')
          .query(true)
      ...
      it(`should return a 200 status if jobs API returns ${code}`, async () => {
        nock('https://api.teleport.org')
          .get('/api/cities/')
          .query(true)
          .reply(200, CITY_INFO)
      ...
      it(`should return a 200 status if city info API returns ${code}`, async () => {
        nock('https://api.teleport.org')
          .get('/api/cities/')
          .query(true)
          .reply(code, CITY_INFO)
